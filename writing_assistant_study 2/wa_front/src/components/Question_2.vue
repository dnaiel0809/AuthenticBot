    ...
    <div class="container">
      <div v-show="condition == 2">
        <p style="font-size: 1.2rem">
          This is the second post. Answer the question regarding the post.
        </p>
      </div>
      ...
      <div v-show="condition == 6">
        <p style="font-size: 1.2rem">
          This is the second post. Instead of writing a supportive message, you
    ...
    async submitWriting() {
      ...
      http
        ...
        .then((res) => {
          ...
          this.jumpyTo("/writing_assitant_show_2");
        })
        .catch((e) => {
          console.log(e);
        });
