  ...
  <div>
    ...
    <div class="container">
      ...
      <p style="font-size: 1.2rem">
        ...
        if you see fit. Once you're happy with your response, please submit the
        message. The message will be saved and uploaded. Then kindly fill out
        the survey below. Note that this support message will be shared
        anonymously in an online peer support community.
      </p>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      this.post = sessionStorage.getItem("main_1");
      this.addHashToLocation();
      if (sessionStorage.getItem("editing_start_" + this.post) === null) {
        console.log("editing_start_" + this.post);
    ...
    nextpage() {
      if (sessionStorage.getItem("editing_end_" + this.post) === null)
        sessionStorage.setItem("editing_end_" + this.post, Date.now());
      this.submitWriting();
      this.serveyBool = true;
    ...
    addSurveyListener() {
      window.addEventListener("message", (e) => {
        ...
        if (
          ...
          e.data.includes("QualtricsEOS|SV_0jpPQlutvKjbZB4")
        ) {
          ...
          if (
            ...
            this.jumpyTo("/question_2");
          else this.jumpyTo("/writing_assitant_show_2");
        }
      });
    },
    addHashToLocation() {
      ...
      iframe.src =
        "https://nus.syd1.qualtrics.com/jfe/form/SV_0jpPQlutvKjbZB4" + params;
    },
  },
};
</script>
