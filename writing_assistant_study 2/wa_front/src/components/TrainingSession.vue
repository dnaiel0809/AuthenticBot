    ...
    <div class="container">
      <div class="bg-light">
        ...
        <p style="font-size: 1.2rem">
          Now, let's move on to the main tasks. You'll see three posts from
          online communities where individuals seek support. An AI will attempt
          to generate messages for these posts. Your input will be crucial for
          the AI to craft more genuine and relatable responses.
        </p>
      </div>
      <center>
