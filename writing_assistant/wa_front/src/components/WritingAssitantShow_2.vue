...
export default {
  ...
  data() {
    return {
      ...
      nextPageBool: false,
      condition: -1,
      post: sessionStorage.getItem("main_2"),
    };
  },
  ...
  methods: {
    fetchData() {
      ...
      // this.example1 = sessionStorage.getItem("example1");
      // this.example2 = sessionStorage.getItem("example2");
      // this.example3 = sessionStorage.getItem("example3");
      // this.example4 = sessionStorage.getItem("example4");
      
      console.log("this.post", this.post);
      console.log("this.example4", this.example4);
    },
